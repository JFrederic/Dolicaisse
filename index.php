            ...
            <div class="row  ">
                ...
                <div class="col-12 ">
                    <div class="row main-caisse" >
                        ...
                        <div class="row">
                            <div class="col-3 bg-primary  bloc-dolibarr" data-bs-toggle="modal" data-bs-target="#clientModal">
                                <h3 class="text-center"><i class="fa-solid fa-user"></i> Client </h3>
                            </div>
                            <div class="col-3 bg-danger bloc-dolibarr" data-bs-toggle="modal" data-bs-target="#factureModal">
                                <h3 class="text-center"><i class="fa-solid fa-file-invoice"></i> Facture </h3>
                            </div>
                            <div class="col-3 bg-success bloc-dolibarr">
                                <h3 class="text-center"><i class="fa-solid fa-box"></i> Cloture Caisse </h3>
                            </div>
                            <div class="col-3 bg-dark bloc-dolibarr">
